...
const RAW = [
  ...
  ['Tarn Orle','attacker',80,84,43,76,75],['Pissboy','attacker',84,88,39,78,71],
  ...
  ['Middle Tom','attacker',90,62,50,70,65],['Tule Sorrel','attacker',88,66,52,75,68],
  ['Pelk Reeve','attacker',92,64,50,68,63],['Boopie','attacker',89,65,51,72,66],
  ...
  ['Young Tom','defender',56,54,89,72,88],['Dun Carraway','defender',53,51,92,68,90],
  ...
  ['Moth Drelk','goalie',48,42,97,66,91],['Old Tom','goalie',44,39,99,65,93],
